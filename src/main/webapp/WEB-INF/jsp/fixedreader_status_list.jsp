        ...
        <div class="main-panel">
            <div class="content-wrapper">
                    ...
                    <div class="page-header">
                        <h3 class="page-title">Fixed RFID Reader Connection Status</h3>
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                              <div class="card-body">
                                <div class="row">
                                  <div class="col-lg-11">
                                      <h4 class="card-title">Fixed RFID Reader Status</h4>
                              ...
                              <div class="row">
                                ...
                                <table id="fixed_reader_status_table" class="table table-hover  table-responsive-lg table-bordered">
                                  ...
                                  <tbody>
                                    ...
                                    <c:forEach var="status" items="${fixedReaderStatusList}" varStatus="fieldRow">
                                        <tr>
                                            <td><c:out value="${counter}"/></td>
                                            <td><c:out value="${status.getReaderId()}"/></td>
