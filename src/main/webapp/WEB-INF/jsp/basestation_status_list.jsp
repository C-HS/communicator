        ...
        <div class="main-panel">
            <div class="content-wrapper">
                    ...
                    <div class="page-header">
                        <h3 class="page-title">Base Station Connection Status</h3>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">Connection Status</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Base Station</li>
                            </ol>
                        </nav>
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                              <div class="card-body">
                                <div class="row">
                                  <div class="col-lg-11">
                                      <h4 class="card-title">Base Station Status</h4>
...
<!--                                   <div class="col-lg-1">
                              ...
                              <div class="row">
                                ...
                                <table id="base_station_status_table" class="table table-hover  table-responsive-lg table-bordered">
                                  <thead>
                                    <tr>
                                      <th>SNo</th>
                                      <th>Config ID</th>
                                  ...
                                  <tbody>
                                    ...
                                    <c:forEach var="status" items="${baseStationStatusList}" varStatus="fieldRow">
                                        <tr>
                                            <td><c:out value="${counter}"/></td>
                                            <td><c:out value="${status.getBsConfigId()}"/></td>
...
<script src="assets/js/todolist.js"></script> -->
    ...
    <script>
            ...
            'use strict';
            $(function() {
                $('#base_station_status_table').DataTable({
                "aLengthMenu": [
                    [5, 10, 15, -1],
                    [5, 10, 15, "All"]
                ],
                ...
                $('#base_station_status_table').each(function() {
                var datatable = $(this);
