			...
			<div class="content-wrapper">
				...
				<div class="row">
						...
						<div class="col-md-12 grid-margin stretch-card">
							<div class="card">
							<div class="card-body">
								<form action="locateContainerLocation" method="POST" class="forms-sample">
									...
									<div class="col-sm-2">
										...
										<input id="locateButton" name="locateButton" type="button" class="form-control  btn-gradient-primary btn-sm mr-2" value ="Locate">
									</div>
									</div>
									</form>
							</div>
				...
				<div class="row">
					...
					<div class="col-md-12 grid-margin stretch-card">
						<div class="card">
						<div class="card-body">
							<h4 class="card-title">Container Location</h4>
							<div id='map'></div>
							<div id="basemaps-wrapper" class="leaflet-bar" style="margin-right: 20px;">
	...
	function placeAlreadyExistingAssets(){}
		...
		if(marker!=null)
		{
			...
			var cno =$("#containerNo").val();
			 $.ajax({
					type:"GET",
					url: 'locateContainer/'+cno,
					success:function(result){
						//alert(result);
						placeContainer(result.latitude,result.longitude,result.epc);
					},
					error:function() {
						alert("error");
					}
