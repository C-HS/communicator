        ...
        <div class="main-panel">
            <div class="content-wrapper">
                    ...
                    <div class="page-header">
                        <h3 class="page-title">Middleware Connection Status</h3>
...
<!--                                   <div class="col-lg-1">
                              ...
                              <div class="row">
                                ...
                                <table id="middleware_status_table" class="table table-hover  table-responsive-lg table-bordered">
                                  <thead>
                                    <tr>
                                      <th>SNo</th>
                                      <th>Config ID</th>
...
<script src="assets/js/todolist.js"></script> -->
    ...
    <script>
            ...
            'use strict';
            $(function() {
                $('#middleware_status_table').DataTable({
                "aLengthMenu": [
                    [5, 10, 15, -1],
                    [5, 10, 15, "All"]
                ],
                ...
                $('#middleware_status_table').each(function() {
                var datatable = $(this);
