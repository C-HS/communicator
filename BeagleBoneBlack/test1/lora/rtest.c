...
#define E61_M0 4   //GPIO4  gpio0[4]
#define E61_M1 5   //GPIO5  gpio0[5]
#define E61_AUX 1  //GPIO65  GPIO2[1]

#define LORA_INIT_LED 29  //GPIO61  gpio1[29]

#define LORA_LED 2  //GPIO66  GPIO2[2]
#define MQTT_LED 3  //GPIO67  GPIO2[3]
int h_led=0;
int h_led_init=0;
...
int connectSerial(char *port, int mode)
{
 ...
 int serial_port = open(port, mode);
  ...
  void initializeLEDs()
  {
   ...
   h_led = lgGpiochipOpen(2);  // Offset 2
   h_led_init = lgGpiochipOpen(1);  // Offset 1

   /* claim some GPIO for OUTPUT */
   lgGpioClaimOutput(h_led, lFlags, LORA_LED, 1); /* initial level 0 */
   lgGpioClaimOutput(h_led, lFlags, MQTT_LED, 1); /* initial level 0 */
   lgGpioClaimOutput(h_led_init, lFlags, LORA_INIT_LED, 0); /* initial level 0 */
...
*/
   ...
   //      printf("\n");
     ...
     //if(flagV==69)
	//{
         // lgGpioWrite(h_led_init,LORA_INIT_LED, 1);
  ...
  /*        if (!MQTTClient_isConnected(client))
	  ...
	  lgGpioWrite(h_led_init,LORA_INIT_LED, 0);
        //}
     }
